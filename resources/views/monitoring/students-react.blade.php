...
<body>
    ...
    <!-- Students Content (will be moved into React layout) -->
    <div id="students-content-wrapper" style="display: none;">
        @include('monitoring.partials.students-content')
    ...
    <script src="{{ asset('js/react-students.js') }}"></script>
    <script>
        window.mountStudents && window.mountStudents();
    </script>
    <script>
