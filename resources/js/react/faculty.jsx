...
function FacultyLayout() {
  ...
  // Hide pagination SVG arrows in faculty module
  useEffect(() => {
    const styleId = 'faculty-pagination-arrow-style';
    if (!document.getElementById(styleId)) {
      const style = document.createElement('style');
      style.id = styleId;
      style.innerHTML = `
        /* Hide chevron SVG arrows in paginator on Faculty page */
        #faculty-content-container nav[role='navigation'] svg {
            ...
            <div className="dropdown">
              ...
              <ul
                ...
                style={{
                  ...
                  borderRadius: '20px',
                  boxShadow:
                    '0 30px 100px rgba(0,0,0,0.4), 0 0 0 1px rgba(255,255,255,0.3), inset 0 2px 0 rgba(255,255,255,0.5), inset 0 -1px 0 rgba(0,0,0,0.1)',
                  padding: '12px',
                  background:
