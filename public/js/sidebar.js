...
class Sidebar {
    constructor() {
        ...
        if (!this.sidebarToggle) {
            console.error('Sidebar: Sidebar toggle button not found!');
        }
    ...
    init() {
        console.log('Sidebar: Initializing events...');
        this.bindEvents();
        this.setupResponsiveBehavior();
    }

    bindEvents() {
        console.log('Sidebar: Binding events...');
        // Sidebar toggle
        if (this.sidebarToggle) {
        ...
        if (profileButton && profileDropdown) {
            ...
            console.warn('Sidebar: Profile dropdown elements not found');
        }
    ...
    toggleSidebar() {
        ...
        if (this.sidebar) {
            ...
            // Also toggle main content margin
            const mainContent = document.querySelector('.main-content');
            if (mainContent) {
                mainContent.classList.toggle('sidebar-collapsed');
            }
            console.log('Sidebar: Sidebar toggled, collapsed:', this.sidebar.classList.contains('collapsed'));
        }
    }
